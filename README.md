...
This year, the course also introduces the Fisheries Integrated Modeling System (FIMS), a next-generation stock assessment framework, to run the FIMS model in parallel with SS3, to help with future transition to FIMS.  
