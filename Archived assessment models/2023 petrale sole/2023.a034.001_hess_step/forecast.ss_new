...
#  2021 2021 2021 2021 2021 2021 1876 2022 1876 2022
...
0.25 # Control rule inflection for constant F (as frac of Bzero, e.g. 0.40); must be > control rule cutoff, or set to -1 to use Bmsy/SSB_unf 
0.05 # Control rule cutoff for no F (as frac of Bzero, e.g. 0.10) 
